...
export default function ServerInspectionTab() {
    ...
    return (
        <div className="mt-6" data-oid="server-inspection-container">
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <label
                                htmlFor="server-auto-inspection-switch"
                            ...
                            >
                                <input
                                    type="checkbox"
                                    id="server-auto-inspection-switch"
                ...
                {autoInspectionEnabled && (
                    <div className="px-6 py-4" data-oid="schedule-settings">
                        <div className="flex items-center space-x-4" data-oid="schedule-container">
                            <label
                                htmlFor="server-schedule-frequency"
