...
export default function BusinessInspectionTab() {
    ...
    return (
        <div className="mt-6" data-oid="business-inspection-container">
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <label
                                htmlFor="business-auto-inspection-switch"
                            ...
                            >
                                <input
                                    type="checkbox"
                                    id="business-auto-inspection-switch"
                ...
                {autoInspectionEnabled && (
                    <div className="px-6 py-4" data-oid="schedule-settings">
                        <div className="flex items-center space-x-4" data-oid="schedule-container">
                            <label
                                htmlFor="business-schedule-frequency"
                            ...
                            <select
                                id="business-schedule-frequency"
