...
export default function InstallWizard({ isOpen, onClose, onComplete }: InstallWizardProps) {
    ...
    const [contentHeight, setContentHeight] = useState(400); // 添加固定内容高度状态
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[800px]" style={{ maxHeight: '90vh', overflowY: 'auto' }}>
                <DialogHeader>
                ...
                <div className="mt-6 px-4">
                    ...
                    <div className="mt-10 mb-4 flex justify-between px-4">
                        <button
                            type="button"
                            onClick={handleBack}
